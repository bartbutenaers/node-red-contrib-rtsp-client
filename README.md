...
Since FFmpeg often does not mention which option is not found, you will need to adjust the log level in the *"Advanced"* tabsheet.  Starting from log level *"Errors"*, useful information about non-fatal errors will appear in the log:
